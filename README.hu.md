...
## Más megfigyelőhely, más home pozíció, másik félteke

Semmilyen hely- vagy mount-specifikus dolog nincs beégetve a pluginbe:

- **A földrajzi hely** minden mentésnél a mount driverétől jön (tartalék: a NINA profil
  csillagászati beállításai), és minden mintával együtt tárolódik; a szideridő- és
  Alt/Az-számítások ezeket használják. Bármely hosszúságon/szélességen — a **déli
  féltekén** is — konfiguráció nélkül működik.
- **Home és park pozíciót a plugin soha nem feltételez.** Azt a fizikai pózt menti és
  állítja vissza, amiben a mount épp van; a home csak egyetlen diagnosztikai jelzésben
  szerepel (pólus-hittel ébredő mount — északi vagy déli pólus), és ha egy mount más
  home-konvenciót használ, ez a jelzés egyszerűen nem szólal meg, minden más működik.
- **Költöztetett felszerelés**: a póz csak azon a helyen érvényes, ahol mentődött. Ha a
  jelentett site ~0,1°-nál (≈ 10 km) többel tér el a mentettől, az automatikus restore
  kimarad (a mentés az új helyen folytatódik); a kézi **Restore now** felülbírálhatja.
- A pozíciók **NINA-profilonként** tárolódnak, több szerelés nem keveredik.
